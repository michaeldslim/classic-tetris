...
export const ko: TranslationSchema = {
  ...
  settings: {
    ...
    playerAvatarVisibility: '아바타 목록',
    playerAvatarShow: '펼치기',
    playerAvatarHide: '접기',
    playerAvatarCollapsedHint: '펼치기를 누르면 아바타를 선택할 수 있습니다.',
    career: '승진제',
    score: '점수',
  ...
  bonus: {
    title: '보너스 게임',
    scoreMultiplier: '라인 클리어 {{multiplier}}× 점수',
    rules: '{{seconds}}초 안에 {{lines}}줄 클리어',
    start: '시작',
    continue: '계속',
    cleared: '보너스 클리어!',
    ended: '보너스 종료',
    earnedScore: '+{{score}}점',
    successHint: '보너스 점수가 누적 점수에 합산됩니다.',
    failHint: '획득한 보너스 점수만 반영됩니다. 캠페인은 계속됩니다.',
  },
  profile: {
    score: '점수',
    level: '레벨',
