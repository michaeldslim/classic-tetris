...
export const en: TranslationSchema = {
  ...
  settings: {
    ...
    playerAvatarVisibility: 'Avatar list',
    playerAvatarShow: 'Expand',
    playerAvatarHide: 'Collapse',
    playerAvatarCollapsedHint: 'Expand the list to choose a different avatar.',
    career: 'Career',
    score: 'Score',
